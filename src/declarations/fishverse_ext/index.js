...
import { idlFactory } from './fishverse_ext.did.js';
export { idlFactory } from './fishverse_ext.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.FISHVERSE_EXT_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./fishverse_ext.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the fishverse_ext canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./fishverse_ext.did.js")._SERVICE>}
 */
export const fishverse_ext = createActor(canisterId);
